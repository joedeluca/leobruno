...
export default function PoemAudioPlayer({ audioUrl }: PoemAudioPlayerProps) {
  ...
  return (
    <div className="mb-6 p-4 bg-zinc-900/50 rounded-lg border border-zinc-800 max-w-fit">
      ...
      <div className="flex flex-col gap-3">
        ...
        {/* Text info and Image - side by side */}
        <div className="flex items-end justify-between">
          <div className="text-xs text-zinc-600">
            {poemInfo && (
              <>
                <div className="italic">{poemInfo.title}</div>
                <div className="italic">by {poemInfo.author}</div>
              </>
            )}
